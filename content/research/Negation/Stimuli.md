...
showTOC: true
---
## 2021-08-20 A detailed explanation of the experiment video
场景：屏幕的左侧放置一张桌子，桌子上方放置两个正方体箱子，这两个箱子是从三种颜色的箱子中选择出来的两个，每种颜色的箱子都可以被重复选择。箱子的颜色有“红、绿、蓝”三种，其中红色箱子两面透明，绿色箱子六面都不透明，蓝色箱子只有一面透明。

屏幕的右侧放置一个带有遮挡布的筐子，筐子里放有三个物体，此时遮挡布是打开的，被试可以看到筐子里放的物体。
0-4s：行为主体从屏幕左侧进入场景，走到桌子中间时停下并转身面向桌子，然后行为主体蹲下分别将头转至左侧箱子和右侧箱子各观察1s。
5-11s：行为主体起身，继续向右侧前进，走到筐子中间时停下并转身，行为主体蹲下观察筐子里的物体，这是物体开始彼此交换位置，遮挡布也逐渐盖住筐子，在遮挡布遮住筐子的过程中三个物体仍在互相交换位置，在物体交换位置的过程中，遮挡布上会有此起彼伏的凸起，直到遮挡布完全遮住筐子，遮挡布上留下三个静止的凸起，行为主体起身。
12-14s：行为主体从屏幕右侧走出场景。
15-24s：筐子上的遮挡布打开，其中两个物体向上方移动，然后，遮挡布会再次盖上筐子，这是遮挡布上只剩下最左侧的一个凸起。紧接着，箱子的盖子会打开，然后两个物体向左侧移动直到分别进入两个箱子中，当物体完全进入箱子后，箱子盖子再次盖上。
25-28s：行为主体从屏幕右侧进入场景，走到筐子中间停下，转身观察只剩下一个凸起的筐子，再将头转向桌子上的两个箱子。
29-34s：行为主体继续向左侧前进，走到桌子中间停下转身，再次蹲下观察两个箱子各1s后，起身选择其中一个箱子。
