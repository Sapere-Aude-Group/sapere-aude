...
- 量子概率理论（QPT）：量子概率论(QPT)，为量子力学中的事件分配概率的规则，没有物理学，是一个概率推理的框架，替代CPT。一些研究人员一直在探索QPT在认知建模中的价值，部分原因是QPT概率推理中固有的情境性。如果在某些情况下，概率推理会显示出情境性，那么QPT可能是提供相应认知模型的合适框架。比如合取谬误。
